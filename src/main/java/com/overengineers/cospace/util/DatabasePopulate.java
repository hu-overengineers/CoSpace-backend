...
public class DatabasePopulate {
    ...
    public void populateDatabase() {
        ...
        for (int i = 0; i < adminList.size(); i++) {
            ...
            Member currentAdmin = new Member(currentUsername, passwordEncoder.encode("12345"), currentEmail + "@gmail.com", null, null, null, Set.of(savedAuthorities.get(0), savedAuthorities.get(1)), null);
        ...
        for (int i = 1; i <= populationCount; i++) {
            ...
            Member member = new Member("member" + i, passwordEncoder.encode("123456"), "member" + i + "@gmail.com", null, null, null, Set.of(new Authority(null, null, "USER")), null);
            memberRepository.save(member);

            Club club = new Club("club" + i, "club" + i + " Details", null);
            clubRepository.save(club);

            SubClub sub = new SubClub("sub" + i, "sub" + i + " Details", 0, null, null, null, null, club, null, null);
